...
public class login extends javax.swing.JFrame {
   ...
   try
   {
       ...
       Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/java_dbmovies","root","7261888792");
       Statement s=c.createStatement();
       
       String a=jTextField1.getText();
       String b=jPasswordField1.getText();
       ResultSet rs=s.executeQuery("select name,password from register");
       while(rs.next())
       {       
